podman-hpc run --rm -it -e SLURM_* -e PALS_* -e PMI_* -e LD_LIBRARY_PATH=/opt/udiImage/modules/mpich:/opt/udiImage/modules/mpich/dep --ipc=host \
...
-v $SCRATCH:/scratch  ghcr.io/dingp/mpich-glibc-swap:latest
