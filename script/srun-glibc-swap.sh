srun --ntasks-per-node 4 -N 2  podman-hpc run --rm -it -e SLURM_* -e PALS_* -e PMI_* -e LD_LIBRARY_PATH=/opt/udiImage/modules/mpich:/opt/udiImage/modules/mpich/dep --ipc=host \
